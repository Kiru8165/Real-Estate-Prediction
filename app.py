...
def predict():
    data = request.form  # Collect input from form
    sqft = float(data['sqft'])
    bhk = int(data['bhk'])
    bath = int(data['bath'])
    location = data['location']  # Process location appropriately

    # Prepare input for model
    # input_features = np.array([[sqft, bhk, bath]])  # Add location encoding if needed
